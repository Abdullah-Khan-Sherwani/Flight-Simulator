class Camera {
    ...
    processKeyboard(direction, deltaTime) {
        ...
        if (direction === 'FORWARD')  glMatrix.vec3.scaleAndAdd(this.Position, this.Position, this.Front,  velocity);
        if (direction === 'BACKWARD') glMatrix.vec3.scaleAndAdd(this.Position, this.Position, this.Front, -velocity);
        if (direction === 'LEFT')     glMatrix.vec3.scaleAndAdd(this.Position, this.Position, this.Right, -velocity);
        if (direction === 'RIGHT')    glMatrix.vec3.scaleAndAdd(this.Position, this.Position, this.Right,  velocity);
    }
